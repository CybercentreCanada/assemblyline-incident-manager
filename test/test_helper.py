...
class TestHelper:
    ...
    @staticmethod
    @pytest.mark.parametrize("url, service_selection, expected_result", [
    ...
    @staticmethod
    @pytest.mark.parametrize("services, expected_result",
        [
    ...
    @pytest.mark.parametrize("value, expected_result", [
        ...
        ("v4:akfkP426PLuy$1X4nDKjY3*y9FblahUs&Uii?r8k2pnq@sN?^", "v4:akfkP426PLuy$1X4nDKjY3*y9FblahUs&Uii?r8k2pnq@sN?^"),
        ("v4:akfkP426PLblah4nDKjY3*y9FxHMhU!s&Uii?r8k2pnq@sN?^\n", "v4:akfkP426PLblah4nDKjY3*y9FxHMhU!s&Uii?r8k2pnq@sN?^"),
        ("v4:akfkP426PL?uy1X4nDKjY3*y9blahUs&Uii?r8k2pnq@sN?^\r", "v4:akfkP426PL?uy1X4nDKjY3*y9blahUs&Uii?r8k2pnq@sN?^"),
        ("\nv4:akfkP426PLuy1X4nDKjY3*y9FxHMhUs&Ui\i?r8k2pnq@sN?^\r", "v4:akfkP426PLuy1X4nDKjY3*y9FxHMhUs&Ui\\i?r8k2pnq@sN?^"),
        ("v3fkP426PLuy1blahY3*y9FxHMhUs&Uii?r8k2pnq@sN?^", "v3fkP426PLuy1blahY3*y9FxHMhUs&Uii?r8k2pnq@sN?^"),
    ])
